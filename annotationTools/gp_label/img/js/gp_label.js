...
function tester_init() {
	...
	DEFAULT_INSTR += '<br>';
	DEFAULT_INSTR += '<li>Press "z" key to zoom-in and zoom-out.</li>';
...
ans_ox[0] = 227;
ans_oy[0] = 447;
ans_x_vector[0] = [-0.9074958562850952,-0.02869814820587635,0.41907963156700134];
ans_y_vector[0] = [0.4187049865722656,0.018103966489434242,0.9079418182373047];
ans_z_vector[0] = [-0.03364325314760208,0.999424159526825,-0.004413216840475798];
fp[1] = 471.61;
ans_ox[1] = 305;
ans_oy[1] = 359;
